System.register(["angular2/core", "angular2/router", '../../services/cookieAuth.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, cookieAuth_service_1;
    var Navbar;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            Navbar = (function () {
                ...
                Navbar = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.Router, cookieAuth_service_1.CookieAuthService])
                ], Navbar);
                return Navbar;
            }());
