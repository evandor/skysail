package io.skysail.server.testsupport.cucumber;
...
public class CucumberStepContext {
    ...
    @Getter
    @Setter
    private SkysailResponse<?> lastResponse;
    ...
    public void post(PostEntityServerResource<?> resource, Map<String, String> data) {
        ...
        setLastResponse(resource.post(form, getVariant()));
    }

    public void delete(EntityServerResource<?> resource) {
        setLastResponse(resource.deleteEntity(getVariant()));
    }
}
