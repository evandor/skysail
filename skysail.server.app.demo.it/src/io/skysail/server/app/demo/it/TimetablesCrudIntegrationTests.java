...
// *
// */
//public class TimetablesCrudIntegrationTests extends BrowserTests<BookmarksBrowser, Bookmark> {
//
...
//        Bookmark application = new Bookmark();//"app1", "pkgName", "../", "projectName");
//       // application.setPath(".");
...
//        browser.create(new Bookmark());//"app1!", "pkgName", "../", "projectName"));
//    }
//
//}
