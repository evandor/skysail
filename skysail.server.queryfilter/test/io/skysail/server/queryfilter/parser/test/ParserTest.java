...
public class ParserTest {
	...
	public void getSelected_from_simple_expression() {
		Set<String> selected = new Parser().getSelected("(buchungstag;YYYY=2009)");
	...
	public void testSelected() {
		Set<String> selected = new Parser().getSelected("(|(buchungstag;YYYY=2009)(buchungstag;YYYY=2008))");
