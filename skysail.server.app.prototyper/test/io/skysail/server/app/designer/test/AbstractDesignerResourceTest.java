...
//
//public abstract class AbstractDesignerResourceTest extends ResourceTestBase2 {
//
//    @Spy
...
//        repo.activate();
//        application.setDesignerRepository(repo);
//        Mockito.when(application.getRepository()).thenReturn(repo);
//    }
//
