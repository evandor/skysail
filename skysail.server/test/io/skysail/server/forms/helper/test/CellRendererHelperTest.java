...
public class CellRendererHelperTest {
    ...
    public void null_input_is_formatted_as_empty_String() {
        Object formatted = new CellRendererHelper(field, response).render(null, "columnName","id", null);
        assertThat(formatted, is(""));
    }

    @Test
    public void list_input_is_formatted_as_lists_size() {
        Object formatted = new CellRendererHelper(field, null).render(Arrays.asList("1","2","3"), "columnName", "id", null);
    ...
    public void set_input_is_formatted_as_sets_size() {
        ...
        Object formatted = new CellRendererHelper(field, null).render(new HashSet<String>() {{ add("1"); add("2"); }}, "columnName", "id", null);
        assertThat(formatted, is("2"));
    }

    @Test
    public void huge_long_is_interpreted_as_date_and_formatted() {
        Object formatted = new CellRendererHelper(field, null).render(1100000000L,  "columnName", "id", null);
