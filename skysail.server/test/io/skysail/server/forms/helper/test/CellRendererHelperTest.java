...
public class CellRendererHelperTest {
    ...
    public void null_input_is_formatted_as_empty_String() {
        Object formatted = new CellRendererHelper(field, response).render(null, "columnName","columnName", "id", null);
        assertThat(formatted, is(""));
    }

    @Test
    public void list_input_is_formatted_as_lists_size() {
        Object formatted = new CellRendererHelper(field, null).render(Arrays.asList("1","2","3"), "columnName","columnName", "id", null);
        assertThat(formatted, is("1<hr>2<hr>3"));
    }

    @Test
    public void set_input_is_formatted_as_sets_size() {
        @SuppressWarnings("serial")
        Object formatted = new CellRendererHelper(field, null).render(new HashSet<String>() {{ add("1"); add("2"); }},"columnName", "columnName", "id", null);
    ...
    public void simple_listResponse_is_formatted_as_columns_value() throws Exception {
        ...
        Object formatted = new CellRendererHelper(field, listResponse).render("abc","columnName",  "columnName", "id", null);
