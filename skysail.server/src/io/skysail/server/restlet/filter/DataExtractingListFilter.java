...
@Slf4j
public class DataExtractingListFilter extends AbstractListResourceFilter {
	...
	private void sanitizeIds(List<?> data) {
	...
	private void sanitizeIds(Object data) {
