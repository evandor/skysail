...
var Bundles = (function () {
    ...
    Bundles.prototype.add = function () {
        this.symbols.push(this.stockForm.value.stock.toUpperCase());
    };
    Bundles.prototype.remove = function (symbol) {
        this.symbols = this.service.remove(symbol);
    };
    Bundles = __decorate([
        angular2_1.Component({
            selector: 'bundles',
            viewBindings: [bundles_1.BundlesService]
        }),
        angular2_1.View({
        ...
        __metadata('design:paramtypes', [bundles_1.BundlesService])
    ], Bundles);
    return Bundles;
})();
exports.Bundles = Bundles;

//# sourceMappingURL=../components/bundles.js.map