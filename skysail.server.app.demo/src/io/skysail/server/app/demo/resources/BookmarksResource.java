...
public class BookmarksResource extends ListServerResource<Bookmark> {
    ...
    public List<Bookmark> getEntity() {
        ...
        return Collections.EMPTY_LIST;//repository.find(filter, pagination);
    }

    @Override
    public List<Link> getLinks() {
              return super.getLinks(PostBookmarkResource.class,BookmarksResource.class, RamlClientResource.class);
    }
}